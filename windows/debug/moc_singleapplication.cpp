...
QT_MOC_LITERAL(1, 18, 6), // "showUp"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 25) // "slotConnectionEstablished"

    },
    "SingleApplication\0showUp\0\0"
...
void SingleApplication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->showUp(); break;
        case 1: _t->slotConnectionEstablished(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SingleApplication::showUp)) {
                *result = 0;
                return;
            }
        }
