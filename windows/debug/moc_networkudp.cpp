...
struct qt_meta_stringdata_networkUDP_t {
    QByteArrayData data[3];
    char stringdata0[33];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_networkUDP_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_networkUDP_t qt_meta_stringdata_networkUDP = {
    {
QT_MOC_LITERAL(0, 0, 10), // "networkUDP"
QT_MOC_LITERAL(1, 11, 20), // "readPendingDatagrams"
QT_MOC_LITERAL(2, 32, 0) // ""

    },
    "networkUDP\0readPendingDatagrams\0"
};
...
const QMetaObject networkUDP::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_networkUDP.data,
      qt_meta_data_networkUDP,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *networkUDP::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_networkUDP.stringdata0))
